...
serve(async (req) => {
  ...
  try {
    ...
    const systemPrompt = `You are an expert programming debugger. Analyze the error and provide:
...
Please explain the issue and provide the corrected code.`;
    ...
    return new Response(
      JSON.stringify({ analysis, fixedCode }),
